	...
	<div class="card card-outline card-success">
		<div class="card-header">
			...
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=new_project"><i class="fa fa-plus"></i> Ajouter</a>
			</div>
            <?php endif; ?>
		</div>
		<div class="card-body">
					...
					<tr>
						...
						<td class="text-center">
		                    ...
		                    <div class="dropdown-menu" style="">
		                      <a class="dropdown-item view_project" href="./index.php?page=view_stage&id=<?php echo $row['id'] ?>" data-id="<?php echo $row['id'] ?>">View</a>
