...
<div class="col-lg-12">
			...
			<div class="callout callout-info">
				<div class="col-md-12">
					<div class="row">
						<div class="col-sm-6">
							<dl>
								<dt><b class="border-bottom border-primary">Nom du Stage</b></dt>
						...
						<div class="col-md-6">
							<dl>
								<dt><b class="border-bottom border-primary">Date debut</b></dt>
	...
	<div class="row">
		<div class="col-md-4">
			<div class="card card-outline card-primary">
				<div class="card-header">
					<span><b>Membres du stage</b></span>
		...
		<div class="col-md-8">
			<div class="card card-outline card-primary">
				<div class="card-header">
					<span><b>List des taches:</b></span>
					<?php if($_SESSION['login_type'] != 3): ?>
					<div class="card-tools">
						<button class="btn btn-primary bg-gradient-primary btn-sm" type="button" id="new_task"><i class="fa fa-plus"></i>Ajouter une tache</button>
					</div>
				<?php endif; ?>
				</div>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<b>Etat d'avancement des membres</b>
					<div class="card-tools">
						<button class="btn btn-primary bg-gradient-primary btn-sm" type="button" id="new_productivity"><i class="fa fa-plus"></i> Ajouter Productivité</button>
					</div>
				</div>
				<div class="card-body">
					<?php 
